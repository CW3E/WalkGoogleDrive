...
def main(args):
    ...
    while index < len(folders):
        try:
           ...
           print(f'================== Exception during folder scan, sleeping for 1 minute then trying again', end='\r')
    ...
    if args.search_files == True:
        ...
        for _index, _folder in enumerate(folders):
            print(f'Getting files in _folder: {_index:04d} ({_folder[0]})                                         ', end='\r')
    ...
    for _index, _folder in enumerate(folders + files):
        print(f'Getting files in folder: {_index:04d} ({_folder[0]})                                   ', end='\r')
        nextPageToken=None
